        ...
        if (sleepingSessions != null && !sleepingSessions.isEmpty()) {
            ...
            List<SleepingSession> sessions = sleepingSessions.stream()
                    .filter(s -> s.endSleep.toLocalDate().equals(s.startSleep.toLocalDate().plusDays(1))
                            ...
                            && s.endSleep.toLocalDate().isBefore(s.startSleep.toLocalDate().plusDays(1)))
                    .toList();
                    ...
                    .peek(s -> {
                        if (s.startSleep.toLocalTime().isAfter(LocalTime.of(23, 0))
                            ...
                            counterOwl.getAndIncrement();
                                ...
                                .of(s.startSleep.getYear(), s.startSleep.getMonth(), s.startSleep.getDayOfMonth(),
                                        22, 0))
                                && s.endSleep.isBefore(LocalDateTime
                                .of(s.endSleep.getYear(), s.endSleep.getMonth(), s.endSleep.getDayOfMonth(),
                                        7, 0))) {
            ...
            return new SleepAnalysisResult("Вы", "нет данных");
        }
    }
}
